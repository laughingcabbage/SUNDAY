package com.sunday.moviesearch.domain;

import com.sunday.cmn.DTO;

public class MovieSearchVO extends DTO {
	String DOCID;			//DOCID 
	String title;			//제목    
	String titleEng;		//영제 
	String genre;			//장르    
	...
	double rate;			//평점 
	String plot;			//줄거리   
	String nowShowing;		//현재상영중
	String regId;			//등록자ID 
	String regDt;			//등록일   
	String modId;			//수정자ID 
	String modDt;			//수정일   
	
	public MovieSearchVO(){}

	public MovieSearchVO(String dOCID, String title, String titleEng, String genre, String directorNm, int directorId,
	...
	public String toString() {
		return "MovieSearchVO [DOCID=" + DOCID + ", title=" + title + ", titleEng=" + titleEng + ", genre=" + genre
